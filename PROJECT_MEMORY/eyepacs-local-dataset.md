...
description: Local EyePACS on D:\personal\phd\datasets is the FULL 88,702-image set; test labels added 2026-06-26 (testLabels15.csv)
metadata:
  type: project
---

`D:\personal\phd\datasets\EyePACS` already holds the **complete** Kaggle Diabetic Retinopathy
...
**2026-06-26:** added `D:\personal\phd\datasets\EyePACS\testLabels15.csv` — the official 2015 test
