...
`/mnt/e/…` args get MSYS-rewritten to `C:/Program Files/Git/mnt/e/…` — use literal paths inside the
...
the cache exists); (b) added `paths.eyepacs_cache_512: /mnt/e/datasets/EyePACS/cache_512_exp4` to
...
`/mnt/e/datasets/EyePACS/cache_512_exp4` (10.7k PNGs + cache_meta.csv). Two safety-disables applied so nothing
...
`bash /mnt/e/dissertation-project/experiments/outputs/RESUME_EXP4_CACHE.sh`** — it un-comments the config key,
