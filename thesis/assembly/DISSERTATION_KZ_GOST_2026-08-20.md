...
> **STAGE-G (түпкі өту) — 2026-08-20.** Жұмыстық автор-жыл дәйексөздері нөмірленген `[N]` түріне түрлендірілді (GOST 7.32-2001 §6.11, алғаш кездесу ретімен). 99 сыртқы дереккөз [1]–[99] болып нөмірленді. Нөмірлер ағылшын тіліндегі мәтінмен ортақ (тіл-инварианттылық).
...
патофизиологиясына арналған шолулар [1, 2]
...
капиллярлық қабатында зақымдануды тудырады, ал Kusuhara және әріптестері [1] перициттердің
...
жаңғыртатынын ескертеді. Түсіндірме толық та емес. Wang пен Lo [3] және Gettinger және
әріптестері [4] ауруды микротамырлық зақымдану, қабыну және нейродегенерацияның қосындысы деп
...
Lo [3] оны бірінші кезектегі анти-VEGF терапиясының басты көрсетілімі ретінде тіркейді.
...
Клиникалық шкала бұл жүкті ауырлық кластарына бөледі. Morya және әріптестері [2] жинақтағандай,
...
Ерте анықтау клиникалық тұрғыдан шешуші, өйткені Kesharwani және әріптестері [5] мен Wang пен Lo [3] хабарлағандай, ауру ерте дәрежелерінде емделеді, ал терапиялық терезе ол әлі бұлыңғыр
...
әріптестері [2] жыл сайынғы ұсынылған тексеруден өтетіндер үлесін пациенттердің үштен бірі мен
...
Шектеу кездейсоқ емес, құрылымдық. Кандидаттың бұрынғы жұмысы [6] осы жұмыс қарастыратын ұлттық контексті сипаттайды. Бүкіл халыққа шамамен 1 200
...
Morya және әріптестері [2] жеткізетін енгізілген автоматтандырылған жүйелер және Yesmukhamedov
және әріптестері [6] баяндайтын ұлттық скрининг бағдарламасы бұл нақты мүмкіндік екенін
...
жіктеледі — Shen және әріптестері [7] арнайы көз түбін жақсарту желісін оқыту үшін дәл осы
...
тек сапаны өзгерте отырып, Fu және әріптестері [8] отыз мыңға жуық кескінді үш сапа деңгейіне
қайта аннотациялап, сапа төмендеген сайын анықтау дәлдігінің монотонды түрде құлдырайтынын тапты.
Zago және әріптестері [9] дәл сол байланыстың дерекқорлар арасында да сақталатынын хабарлайды,
ал Dai және әріптестері [10] өнеркәсіптік жүйесі дәрежелеудің алдына айқын сапа кезеңін қояды.
...
Екінші бағыт сапаны корпустар арасындағы айырманың ең үнемді түсіндірмесі ретінде қарайды. Rakhlin [11] бір сыртқы корпуста қисық астындағы ауданның екіншісіндегіден едәуір жоғары болғанын
...
дереккөздер арасында дәлме-дәл бірдей ұстаудан келеді. Voets және әріптестері [12] Gulshan және
әріптестері [13] конвейерін ашық деректерде қайта жаңғыртты. Олар бір тест корпусында қисық
...
Voets және әріптестері [12] шамадан тыс күшті оқылымға жол бермейтін екі нюанстың бірінші
...
Beede және әріптестері [14] сүзгінің құнын орналастыру жағынан күшейтеді: он бір клиникада
...
Екінші нюанс міндетке тәуелділікке қатысты. Liu және әріптестері [15] баяндаған бенчмаркта
...
[16]. Ол бір шағын архитектураға сүйенеді әрі айқын
...
Әдебиет мұны домендік ығысу ретінде зерттейді. Zhou және әріптестері [17] саланы шолып,
...
үлестірімнен тыс нысанада әдетте елеулі құлдырауға ұшырайтынын атап өтеді. Wang пен Deng [18]
...
жасалған жалпы мақсаттағы архитектураларды бейімдеді [19, 20, 21, 22], ал сарапшымен салыстырмалы дәрежелеудің
бетбұрысты көрсетілімдері [13] торқабыққа арнайы жобаларда емес, дәл
сол backbone-дарда құрылды. Litjens және әріптестері [23] осы қозғалысты медициналық бейнелеу
бойынша кеңірек шолады.

Ол архитектуралар сүйенетін тереңдікті оқытуға келетін етіп екі байланыс жаңалығы жасады. He және
әріптестері [24] әр блокты бірегейлік қысқа жолдары арқылы өз кірісіне қатысты қалдық функцияны
үйренетіндей қайта тұжырымдайды, ал Huang және әріптестері [25] алдыңғы қабаттардың барлығының
шығысын біріктіріп жалғайды; екеуі де тереңдік артқанда орнығатын деградацияны шешеді. Одан кейін
Tan мен Le [26] тереңдікті, енді және ажыратымдылықты бірлесіп масштабтайды. Мұнда олар
...
үйлеспейтін міндеттер, корпустар және валидация хаттамалары бойынша [27, 28, 29, 30, 31]. Аналитикалық тұрғыдан маңызды факт — дәл осы біркелкісіздік: бұл сандар
...
тасымалданады [32, 33, 34].

Соңғы жылдардағы жұмыстар бұл ландшафтқа transformer және гибридті жобаларды қосты [35, 36, 37, 38, 39, 40]. Олар салыстыру
...
жуық болатындай тиімді [41, 42], ал Cheplygina және
әріптестері [43] оның негізін береді: ерте конволюциялық белгілер негізінен жалпы сипатта әрі
...
Zhou және әріптестері [44] торқабық кескіндерінде өздігінен бақыланатын алдын ала оқыту
жалпыланатын торқабықтық репрезентациялар беретінін, ал Azizi және әріптестері [45] домен ішіндегі
...
арасында жатыр, ал Saxena және әріптестері [46] деректер мүмкіндік берген жерде екіншісінің
...
Басым тұқымдас класс дәлелін соңғы конволюциялық активацияларға кері проекциялайды [47]. Selvaraju және әріптестері [48] ұсынған градиентке негізделген түрі кез
келген конволюциялық архитектураға қайта оқытусыз қолданылады, сондықтан ол әдепкі тәсілге
айналды, ал Chattopadhyay және әріптестері [49] нақтылауы градиенттердің қалай салмақталатынын
өзгертеді. Модельден тәуелсіз баламалар да бар [50, 51].

Саланың бұл карталарды қолдануы маңызды бір қырынан біркелкі болмады, оны Samek және әріптестері [52] мен Tjoa мен Guan [53] шолулары атап өтеді. Назар картасы мен сарапшы аннотациясының
...
мұндағы дәлелге тікелей қатысты. Wan және әріптестері [54] ұсақ зақымдану белгілерін сақтау үшін
...
Саланың жоғары өнімді жүйелер шығарғаны дауға түспейді. Gulshan және әріптестері [13] терең
...
Abramoff және әріптестерінің [55] жүйесі перспективті көпорталықты сынақта нормативтік рұқсатқа
қол жеткізді.

Әдебиет сондай-ақ бір орталықтағы ішкі валидациядан әлдеқайда әрі жетілді: Ting және әріптестерінің [56] көпэтносты сыртқы когорттары, Сахарадан оңтүстіктегі Африкадағы популяцияаралық валидация
[57], ондаған мың кескін бойынша көпорталықты валидация [58] және ұлттық скрининг бағдарламасының ішіндегі перспективті бағалау
[59]. Ting және әріптестері [60] мен Senapati және әріптестері [61] саланы тұтастай шолады, ал Wewetzer және әріптестері [62] бастапқы медициналық көмек
...
|---|---|---|---|---|---|
| Gulshan және әріптестері [13] | Бинарлы, жолдама берілуге тиіс | Жабық әзірлеу деректері; екі ретроспективті валидация жиыны | ROC-AUC 0.991 және 0.990 | Қос сыртқы | Алдын ала өңдеу қосымша материалға шығарылған |
| Abràmoff және әріптестері [55] | Бинарлы, автономды | 900 пациент, бастапқы медициналық көмектің он алаңы | Сезімталдық 87.2%, спецификалық 90.7% | Перспективті түйінді сынақ | Алдын ала өңдеу абляциясы жоқ, ашық бенчмарк жоқ |
| Ting және әріптестері [56] | Жолдама берілуге тиіс | Жабық, оған қоса он көпэтносты жиын | ROC-AUC 0.936; сыртқы 0.889–0.983 | Көпэтносты сыртқы | Әзірлеу деректері жабық |
| Bellemo және әріптестері [57] | Жолдама берілуге тиіс | 4 504 кескін, Замбия | ROC-AUC 0.973 | Популяцияаралық | Бір елдегі когорт |
| Zhang және әріптестері [58] | Жолдама берілуге тиіс | 83 465 кескін, төрт орталық | Пациент бойынша AUROC 0.9848 | Көпорталықты | Бір ел; алдын ала өңдеу хабарланбаған |
| Ruamviboonsuk және әріптестері [59] | Көруге қауіп төндіретін | 7 651 пациент, тоғыз алаң | Дәлдік 94.7%, сезімталдық 91.4% | Перспективті, ұлттық бағдарлама | Архитектура мен алдын ала өңдеу мөлдір емес |
| Sánchez-Gutiérrez және әріптестері [63] | Жолдама берілуге тиіс | Жабық, Испания | ROC-AUC 0.988 | Клиникалық валидация | Деректер жабық |
| Baget-Bernaldiz және әріптестері [64] | Төрт класты | Жабық, оған қоса бір ашық жиын | ROC-AUC 0.988 және 0.968 | Сыртқы | Бір популяцияда әзірленген |
| Saxena және әріптестері [46] | Бинарлы | Ашық әзірлеу деректері, екі ашық тест жиыны | ROC-AUC 0.958 және 0.92 | Корпусаралық | Бинарлы міндет; алдын ала өңдеу сырттан алынған |
| Wewetzer және әріптестері [62] | Жолдама берілуге тиіс, біріктірілген | Бастапқы медициналық көмектегі он зерттеу | Жиынтық ROC-AUC 0.9543 | Мета-талдау | Әртекті зерттеулерді біріктіреді |
...
тоғыз офтальмологиялық жүйені салыстыру [6] енгізілген
...
әрі мөлдір емес, ал жоғары өнімді кейбір модельдер, мысалы Ryu және әріптестерінің [65] моделі,
...
толық баяндалмаған [12, 13], орналастыру
туралы бірнеше есепте мүлде түсіп қалған, әрі модельдің компоненті ретінде сирек оқшауланған
немесе формальданған. Senapati және әріптестерінің [61] шолуы дәл сол жазбаны қарайды әрі
...
хаттамасына қояды [13, 61]. Бұл байқалатын
...
Үшінші тұқымдас пішінді өзгертпей, сапаны төмендетеді [66]: ол ықтималдығы
...
жүзінде шешеді. Билатералды сүзгілеу [67] орташалауды кеңістіктік
жақындықпен қатар фотометриялық ұқсастық бойынша салмақтайды, сондықтан қарқындылық шекарасының
екі жағындағы пиксельдер бір-біріне жайылмайды; жергілікті емес орташалау [68] ұқсастықты көршілестіктен кескін бойындағы патчтардың өзара ұқсастығына дейін жалпылайды.
...
Конвейер кандидаттың бұрын жарияланған жұмыстарында [16] басталған желіні — онда дәстүрлі алдын ала өңдеу шағын конволюциялық желіде
...
хабарлайды [46], бенчмарк зерттеулері кескін сапасының дәрежелеу
сенімділігіне әсер ететінін хабарлайды [8, 15], ал
жақсарту жөніндегі зерттеулер контраст операцияларының жіктеуге көмектесетінін немесе бір
архитектура үшін зиян тигізетінін хабарлайды [69, 70].
...
Гистограммалық теңестіру [71] (Histogram Equalization) қарқындылықтарды
...
Шешім — Zuiderveld [72] орнатқан эквиваленттілік: бейнелеудің көлбеуін шектеу гистограмманың
...
белгілейді. Pizer және әріптестері [71] сондай-ақ қолайлы кесу деңгейлерінің бейнелеу
...
Кандидаттың бұрынғы жұмысы [16] қорытып шығарылатын клипті жалғыз
...
себебін күшейтеді. Hayati және әріптестері [69] контрасты шектелген теңестіруді төрт архитектурада
...
нашарлайды, әрі бұл — артық үйрену емес, оңтайландыру сәтсіздігі. He және әріптестері [24] мұны
...
Мұны Wan және әріптестерінің [54] зақымдануды сегменттейтін желісі көрсетеді: ол ұсақ зақымдану
...
әріптестерінің [24] қалдық архитектурасының елу қабатты данасы, оның айқындаушы элементі —
бірегейлік қысқа жолы. Екіншісі — Tan мен Le [26] құрама масштабтау тұқымдасының мүшесі, онда
...
ауқымынан тыс, ал кеңірек ландшафт [35, 37]
...
[73] бірліктердің сынғыш, бірлесіп бапталған детекторларға
бейімделуіне жол бермейді, ал batch normalization [74] оңтайландыруды
...
айқындалғандай әрекет етеді [75]. Бірде-бірі артық үйренуді
...
Негізгі хаттама — Grill және әріптестерінің [76] теріс мысалсыз мақсат функциясы; ол шағын
batch-тарға төзімді, сондықтан бір құрылғылық есептеу бюджетіне жарамды; ал He және әріптестері [77], Chen және әріптестері [78], Chen пен He [79] және Caron және әріптестері [80]
баламалары сақталады; Arrieta және әріптестері [81] осы тұқымдасты дәл осы ауруға қолданады. Әрі
...
adversarial туралау жолымен бейімдеу [82] — сол алшақтыққа берілген өзге
жауап әрі мұнда таңдалған жауап емес. Zhou және әріптестерінің [44] жарияланған торқабықтық
...
Бұл таңдаудың әдебиеттегі мәртебесін анық айту қажет. Zhou және әріптестері [44] торқабық
кескіндерінде домен ішіндегі өздігінен бақыланатын алдын ала оқыту жалпыланатын репрезентациялар
беретінін, ал Azizi және әріптестері [45] домен ішіндегі медициналық алдын ала оқытудың табиғи
кескіндерден тасымалдаудан асып түсуі мүмкін екенін хабарлайды; Shurrab пен Duwairi [83]
...
әріптестері [84] көрсеткендей, жоғары деңгейлі белгілер міндетке ең тәуелді, демек бейімдеуден
...
Мақсат функциясы — кері жиілікті класс салмақтауы бар Lin және әріптестерінің [85] focal loss-ы;
ол Cui және әріптестерінің [86] тиімді сан бойынша қайта салмақтауына балама, әрі онда екі тетік
...
әріптестерінің [87] жүйелі шолуы қаралған жүз жетпіс үш мақаланың екеуі ғана валидация зерттеуі
екенін тапты. Buda және әріптестері [88] теңгерімсіздікке қарсы шаралар туралы ұқсас оқылымға
...
Тізбек Zhou және әріптестерінің [47] класс активациясын карталауынан басталады. Соңғы белгі
...
Selvaraju және әріптестерінің [48] градиентке негізделген жалпылауы сол салмақтарды градиенттермен
...
келген конволюциялық архитектураға қайта оқытусыз қолданылады. Chattopadhyay және әріптестерінің [49] кейінгі нақтылауы пиксельдік салмақтарды жоғары ретті мүшелерден шығарады; мұндағы нұсқалар
...
өлшейді. Екіншісі — Everingham және әріптестерінің [89] симметриялы «қиылысу бөлінген бірігу»
өлшемі; оның бөлімі назардың зақымданудан тыс шығып кеткені үшін де, назар жаба алмаған зақымдану
үшін де айып салады; Rezatofighi және әріптестері [90] оның мінез-құлқын талдайды.
...
Құрылымдық ұқсастық Wang және әріптестерінің [91] жалпы кескін сапасы бенчмаркінен шығады, оның
...
құбылмалылығы көрінерлік өнімділікті елеулі ығыстыра алады [92], ал
...
де хабарланады. Калибрлеу күтілетін калибрлеу қатесі мен Brier ұпайы арқылы бағаланады [93], олар болжанған ықтималдықтардың байқалған жиіліктерге сәйкес келетінін сандық
...
Оңтайландыру бүкіл бойында Kingma мен Ba [94] бейімделмелі момент әдісімен жүреді. Белгісіздігі
...
EyePACS-ті Cuadros пен Bresnick [95] құжаттайды, олардың телемедициналық дескрипторы ICDR
...
Messidor-2-ні Decenciere және әріптестері [96], ал құрылғылық корпустарды өзгелермен қатар Liu
және әріптестері [15] құжаттайды. IDRiD-ті Porwal және әріптестері [97] құжаттайды: бір
...
|---|---|---|---|---|
| Gulshan және әріптестері [13] | Бинарлы, жолдама берілуге тиіс | Жабық оқыту деректері; екі ретроспективті валидация жиыны | Офтальмологтар алқасы | ROC-AUC 0.991 және 0.990 |
| Ting және әріптестері [56] | Бинарлы, жолдама берілуге тиіс | Ұлттық бағдарлама, он сыртқы когорт | Бүркемеленген торқабық маманы | ROC-AUC 0.936 |
| Abràmoff және әріптестері [55] | Бинарлы, автономды жолдама | Перспективті, 900 пациент, он алаң | Оқу орталығының дәрежелеуі | Сезімталдық 87.2%, спецификалық 90.7% |
| Zhang және әріптестері [58] | Бинарлы, жолдама берілуге тиіс, пациент деңгейінде | 83 465 кескін, төрт орталық, жабық | Мамандар консенсусы | ROC-AUC 0.9848 |
| Ruamviboonsuk және әріптестері [59] | Бинарлы, көруге қауіп төндіретін | Перспективті орналастыру, тоғыз алаң | Төрелікпен келісілген мамандар | Сезімталдық 91.4%, спецификалық 95.4% |
| De Fauw және әріптестері [98] | Оптикалық когеренттік томографиядан жолдама | Жабық | Жолдама консенсусы | Өзге модальдік |
| Rakhlin [11] | Бинарлы, жолдама берілуге тиіс | EyePACS оқыту деректері, екі ашық тест жиыны | Ашық деректер жиынының таңбалары | ROC-AUC 0.967 және 0.923 |
| Wewetzer және әріптестері [62] | Мета-талдау, бастапқы медициналық көмек | Әртекті, біріктірілген | Зерттеуге тәуелді | Жиынтық ROC-AUC 0.9543 |
...
Архитектура мұнда алғаш рет ұсынылып отырған жоқ. Кандидаттың бұрынғы жұмысы [6] офтальмологиялық скринингке арналған модульдік жүйені ұсынып, оны кескінді
...
Бастапқы жобаның екі интеграциялық беті айқындама күйінде қалады әрі құрылмаған. Nandal [99]
...
Бастапқы жоба [6] сипаттайтын екі мүмкіндік айқындама күйінде
...
әрі мұнда іске аспаған. Екеуі де кеңірек жазбада орныққан жеткізу тәсілдері [2, 57, 60].
...
Бастапқы жобаның [6] деректерді қорғау шеңберлеуі — сертификатталған
...
мұнда көрсетілген ешнәрсемен өзгермейді. Beede және әріптестері [14] мұндай алғышарттары жоқ
...
> Алғаш кездесу ретімен (GOST 7.32-2001, 6.11-тармақ), GOST 7.1-2003 бойынша сипатталған. Дереккөздер тізімі ағылшын тіліндегі мәтінмен бірдей нөмірленген (тіл-инварианттылық).
...
> **Ескерту — кандидаттың жеке жарияланымдары.** Мәтінде дәйексөз келтірілген кандидаттың алдыңғы жұмыстары бұл тізімде GOST талабына сай басқа кез келген дереккөзбен бірдей негізде нөмірленген; кандидаттың тақырып бойынша жарияланымдарының толық тізбесі — жеке ғылыми еңбектер тізімі. Әрқайсысын алдыңғы жеке жұмыс ретінде сипаттайтын тұжырым оны енгізетін мәтінде сақталған және нөмірлеу оған әсер етпейді. Екі әдебиет жазбасы бір мақаланы сипаттайды, сондықтан бір нөмір алады және екі бөлек растау ретінде оқылмайды.
