...
**Композиттік тәуелсіз айнымалы (Composite independent variable)** – Эксперимент 1-дің біріктірілген басқарылатын факторы, мұнда толық конвейер тармағы baseline-нан preprocessing өсі (сегіз кезеңді конвейер vs. созып-масштабтау + ImageNet) және pretraining өсі (офтальмологияға бейімделген SSL vs. ImageNet) бойынша бірге ерекшеленеді.
...
**Интеграцияланған конвейер үстемдігі** – біріктірілген толық конвейер конфигурациясы baseline-нан біртұтас жүйе ретінде асып түседі деген негізгі гипотеза; эмпирикалық үстемдік критерийі (weighted F1 ≥ 5 пп өсу, ROC-AUC ≥ 0.02 өсу, Kappa нашарламауы) орындалғанда валидацияланады.
...
**Transfer Learning** – алдын ала оқытылған желі салмақтарын fundus-кескін доменіне қайта пайдалану және бейімдеу; Эксперимент 1 бойынша инициализация көзі тармаққа бағынады (baseline үшін ImageNet, толық конвейер үшін офтальмологияға бейімделген SSL).
...
патофизиологиясына арналған шолулар (Kusuhara т.б., 2018; Morya т.б., 2024)
...
капиллярлық қабатында зақымдануды тудырады, ал Kusuhara т.б. (2018) перициттердің
...
жаңғыртатынын ескертеді. Түсіндірме толық та емес. Wang пен Lo (2018) және Gettinger т.б. (2025) ауруды микротамырлық зақымдану, қабыну және нейродегенерацияның қосындысы деп
...
Бұл айырма кескінге негізделген жіктеуіш үшін маңызды. Көз түбі фотосуреті микротамырлық көріністерді беретіндіктен, стандартты клиникалық шкала бойынша дәрежеленген модель ең ерте
...
Жіктеуіш үшін бұл зақымданулар – жұмысшы кескіндік белгілер, әрі олардың көзге түсуі біркелкі болмайды. Ең ерте әрі скрининг үшін ең сын дәрежелерді айқындайтын микроаневризмалар мен ұсақ қан
...
Клиникалық шкала бұл жүкті ауырлық кластарына бөледі. Morya т.б. (2024) жинақтағандай,
...
Оның екі қасиеті автоматтандырылған дәрежелеуіштің жобасына тікелей әсер етеді. Шкала реттік болғандықтан, қате жіктеудің клиникалық құны болжанған және шынайы дәреженің арасындағы қашықтыққа
...
Ерте анықтау клиникалық тұрғыдан шешуші, өйткені Kesharwani т.б. (2021) мен Wang пен Lo
...
Қажетті скринингтің жүзеге аспай отырғанын байқалған қамту көрсеткіші көрсетеді: Morya т.б. (2024) жыл сайынғы ұсынылған тексеруден өтетіндер үлесін пациенттердің үштен бірі мен
...
Шектеу кездейсоқ емес, құрылымдық. Кандидаттың бұрынғы жұмысы (Yesmukhamedov т.б.,
...
шектеулі әрі географиялық шоғырланған ұсынысы үлкен, ішінара ауылдық популяцияға таралған сұранысты қанағаттандыра алмайды. Сондықтан маман санын арттыру арқылы қамтуды ұлғайту жақын мерзімде іске аспайды. Түйінді сұрақ дәрежелеу қадамын ішінара автоматтандыруға бола ма дегенге ауысады.

Morya т.б. (2024) жеткізетін енгізілген автоматтандырылған жүйелер және Yesmukhamedov
т.б. (2025) баяндайтын ұлттық скрининг бағдарламасы бұл нақты мүмкіндік екенін
...
Кандидаттың бұрынғы жұмысында (Sapakova, Daniyarova, Yesmukhamedov, Armankyzy, Emberdieva және Kaldybaeva, 2025) баяндалған осы байланысқан модельді
имитациялау сапалық сипатта.
...
клиникалық өлшеммен валидацияланбағандықтан, клиникалық деңгейдегі ешқандай тұжырымды
қолдамайды.
...
жіктеледі – Shen т.б. (2020) арнайы көз түбін жақсарту желісін оқыту үшін дәл осы
...
Екіншісі – фотометриялық. Көз түбі фотосуреті иілген, жартылай шағылысатын ішкі бетті шағын қарашық арқылы жарықтандыратындықтан, жарықтандыру сирек біркелкі болады: виньеттеу, орталық
...
жиі бұзылады. Оның ерекшелігі – себептері аспапта емес, ішінара пациенттің өзінде. Сондықтан оны камераны жетілдіру арқылы жоюға болмайды әрі ол кез келген нақты скрининг популяциясында сақталады.

Бұл остер орналастыру контексіне байланысты. Әрқайсысы тасымалды, маман емес операторлар
...
тек сапаны өзгерте отырып, Fu т.б. (2020) отыз мыңға жуық кескінді үш сапа деңгейіне
қайта аннотациялап, сапа төмендеген сайын анықтау дәлдігінің монотонды түрде құлдырайтынын тапты.
Zago т.б. (2018) дәл сол байланыстың дерекқорлар арасында да сақталатынын хабарлайды,
ал Dai т.б. (2021) өнеркәсіптік жүйесі дәрежелеудің алдына айқын сапа кезеңін қояды.
...
дереккөздер арасында дәлме-дәл бірдей ұстаудан келеді. Voets т.б. (2019) Gulshan т.б. (2016) конвейерін ашық деректерде қайта жаңғыртты. Олар бір тест корпусында қисық
...
Voets т.б. (2019) шамадан тыс күшті оқылымға жол бермейтін екі нюанстың бірінші
...
Beede т.б. (2020) сүзгінің құнын орналастыру жағынан күшейтеді: он бір клиникада
...
Екінші нюанс міндетке тәуелділікке қатысты. Liu т.б. (2022) баяндаған бенчмаркта
...
Бұлардың бірде-бірі өткінші түсіру қатесі емес. Әрқайсысы – камера моделінің тұрақты қасиеті. Осының салдарынан бір торқабықты түсірген екі камера жүйелі әрі болжамды түрде ерекшеленетін кескіндер
береді, ал модель үйренетін көрініс статистикалары оның оқыту кескіндерін өндірген құрылғымен
ішінара шатасып жатады.

Әдебиет мұны домендік ығысу ретінде зерттейді. Zhou т.б. (2022) саланы шолып,
...
Саланың жоғары өнімді жүйелер шығарғаны дауға түспейді. Gulshan т.б. (2016) терең
...
Abramoff т.б. (2018) жүйесі перспективті көпорталықты сынақта нормативтік рұқсатқа
қол жеткізді.

Әдебиет сондай-ақ бір орталықтағы ішкі валидациядан әлдеқайда әрі жетілді: Ting т.б.
(2017) көпэтносты сыртқы когорттары, Сахарадан оңтүстіктегі Африкадағы популяцияаралық валидация
(Bellemo т.б., 2019), ондаған мың кескін бойынша көпорталықты валидация (Zhang т.б., 2022) және ұлттық скрининг бағдарламасының ішіндегі перспективті бағалау
(Ruamviboonsuk т.б., 2022). Ting т.б. (2019) мен Senapati т.б.
(2024) саланы тұтастай шолады, ал Wewetzer т.б. (2021) бастапқы медициналық көмек
...
|---|---|---|---|---|---|
| Gulshan т.б. (2016) | Бинарлы, жолдама берілуге тиіс | Жабық әзірлеу деректері; екі ретроспективті валидация жиыны | ROC-AUC 0.991 және 0.990 | Қос сыртқы | Алдын ала өңдеу қосымша материалға шығарылған |
| Abràmoff т.б. (2018) | Бинарлы, автономды | 900 пациент, бастапқы медициналық көмектің он алаңы | Сезімталдық 87.2%, спецификалық 90.7% | Перспективті түйінді сынақ | Алдын ала өңдеу абляциясы жоқ, ашық бенчмарк жоқ |
| Ting т.б. (2017) | Жолдама берілуге тиіс | Жабық, оған қоса он көпэтносты жиын | ROC-AUC 0.936; сыртқы 0.889–0.983 | Көпэтносты сыртқы | Әзірлеу деректері жабық |
| Bellemo т.б. (2019) | Жолдама берілуге тиіс | 4 504 кескін, Замбия | ROC-AUC 0.973 | Популяцияаралық | Бір елдегі когорт |
| Zhang т.б. (2022) | Жолдама берілуге тиіс | 83 465 кескін, төрт орталық | Пациент бойынша AUROC 0.9848 | Көпорталықты | Бір ел; алдын ала өңдеу хабарланбаған |
| Ruamviboonsuk т.б. (2022) | Көруге қауіп төндіретін | 7 651 пациент, тоғыз алаң | Дәлдік 94.7%, сезімталдық 91.4% | Перспективті, ұлттық бағдарлама | Архитектура мен алдын ала өңдеу мөлдір емес |
| Sánchez-Gutiérrez т.б. (2022) | Жолдама берілуге тиіс | Жабық, Испания | ROC-AUC 0.988 | Клиникалық валидация | Деректер жабық |
| Baget-Bernaldiz т.б. (2021) | Төрт класты | Жабық, оған қоса бір ашық жиын | ROC-AUC 0.988 және 0.968 | Сыртқы | Бір популяцияда әзірленген |
| Saxena т.б. (2020) | Бинарлы | Ашық әзірлеу деректері, екі ашық тест жиыны | ROC-AUC 0.958 және 0.92 | Корпусаралық | Бинарлы міндет; алдын ала өңдеу сырттан алынған |
| Wewetzer т.б. (2021) | Жолдама берілуге тиіс, біріктірілген | Бастапқы медициналық көмектегі он зерттеу | Жиынтық ROC-AUC 0.9543 | Мета-талдау | Әртекті зерттеулерді біріктіреді |
...
Оның салдары сын емес, практикалық. Олардың алдын ала өңдеуі айқындалмағандықтан, нәтижелерін ыдыратуға болмайды. Ақырғы нүктелер мен корпустар үйлескен күннің өзінде салыстыруды
...
тоғыз офтальмологиялық жүйені салыстыру (Yesmukhamedov т.б., 2025) енгізілген
...
әрі мөлдір емес, ал жоғары өнімді кейбір модельдер, мысалы Ryu т.б. (2021) моделі,
...
толық баяндалмаған (Gulshan т.б., 2016; Voets т.б., 2019), орналастыру
туралы бірнеше есепте мүлде түсіп қалған, әрі модельдің компоненті ретінде сирек оқшауланған
немесе формальданған. Senapati т.б. (2024) шолуы дәл сол жазбаны қарайды әрі
мұндай оқшаулауды хабарламайды.

Сонымен, олқылық – дәлдік тапшылығы емес, әдіс тапшылығы: алдын ала өңдеудің үлесі модельдің
...
Жобаның адалдығы үшін оның екі тармағы бір мезгілде екі ось бойынша ерекшеленетінін тіркеу маңызды: байқалған кез келген әсер интеграцияланған конфигурацияның бірлескен үлесі
...
хаттамасына қояды (Gulshan т.б., 2016; Senapati т.б., 2024). Бұл байқалатын
...
оқыту кезінде де, инференс кезінде де қолданылатындықтан, өнеркәсіптік түрлендіру
...
диск–фовеа осі көлденең тұратындай бұрады. Детектор жіктеуішпен бірге оқытылмай, алдын ала оқытылып қатырылған. Сондықтан кезең бекітілген түрлендіру болып қалады, ал модельді алдын ала өңдеу мен
...
түбінің дөңгелек геометриясын және зақымданулардың шынайы қырлар қатынасын сақтайды: микроаневризма эллипске созылмайды. Бұдан туындайтын толықтыру одан кейін маска арнасы арқылы айқын
...
Контрастты күшейту перцептивті түс кеңістігінің жарықтық арнасында жүретіндіктен, контраст түс реңкі жылжымай артады, әрі ол оқыту кезінде стохастикалық, инференс кезінде детерминацияланған
...
әдейі тар белдеу шегінде әрі әрқайсысы тәуелсіз қолданылады. Сол себепті нақты кескін төртеуінің
...
Үшінші тұқымдас пішінді өзгертпей, сапаны төмендетеді (Cubuk т.б., 2020): ол ықтималдығы
...
жақындықпен қатар фотометриялық ұқсастық бойынша салмақтайды, сөйтіп қарқындылық шекарасының
екі жағындағы пиксельдер бір-біріне жайылмайды; жергілікті емес орташалау (Buades т.б.,
2011) ұқсастықты көршілестіктен кескін бойындағы патчтардың өзара ұқсастығына дейін жалпылайды.
Екеуі де медициналық бейнелеуде бағаланбай, қорытып шығару мен сапалық мысалдар арқылы берілген. Сондықтан олар қағидат үшін дәйексөзделеді, ешқандай кейінгі ұтыс үшін емес.
...
Конвейер кандидаттың бұрын жарияланған жұмыстарында (Sapakova, Yesmukhamedov пен Sapakov, 2025;
Sapakova, Yesmukhamedov, Sapakov, Yemberdiyeva және Kozhamkulova, 2025; Yesmukhamedov, Sapakova, Kozhamkulova, Daniyarova және Armankyzy, 2025) басталған желіні – онда дәстүрлі алдын ала өңдеу шағын конволюциялық желіде
валидациялық дәлдікті едәуір көтерген, жетілдірілген теңестіру нұсқасы басқа торқабықтық
дерекқорда зерттелген, ал алдын ала өңдеу жиынтығы осы жерде дәрежеленетін корпуста тірек желіні
кезеңдеп бейімдеумен ұштастырылған – формальданған сегіз кезеңді, төрт арналы конструктіге дамытады. Сол ертеректегі
...
хабарлайды (Saxena т.б., 2020), бенчмарк зерттеулері кескін сапасының дәрежелеу
сенімділігіне әсер ететінін хабарлайды (Fu т.б., 2020; Liu т.б., 2022), ал
жақсарту жөніндегі зерттеулер контраст операцияларының жіктеуге көмектесетінін немесе бір
архитектура үшін зиян тигізетінін хабарлайды (Hayati т.б., 2023; Shaout пен Han, 2025).

Осылайша, конвейер қызмет ететін мақсат – диагностикалық тұрғыдан мәнді белгілерді сақтай отырып,
...
ізашар ретінде дәйексөзделеді, тәуелсіз дәлел ретінде емес. Сол
...
нашарлайды, әрі бұл – артық үйрену емес, оңтайландыру сәтсіздігі. He т.б. (2016) мұны
...
Мұны Wan т.б. (2021) зақымдануды сегменттейтін желісі көрсетеді: ол ұсақ зақымдану
...
Бүкіл жұмыс бойында әртүрлі тұқымдастан алынған екі backbone қолданылады. Біріншісі – He т.б. (2016) қалдық архитектурасының елу қабатты данасы, оның айқындаушы элементі –
...
Яғни, олар терең белгі шығарғышты құрудың шынымен әртүрлі екі қағидатын бейнелейді, әрі оларды
...
ішіндегі инициализациясы тек инициализацияны өзгертеді, сөйтіп қарама-қарсылық шатаспайды.
Конволюциялық және transformer архитектураларын салыстыру сұрағы осы жұмыстың тұжырымдарының
ауқымынан тыс, ал кеңірек ландшафт (Dosovitskiy т.б., 2021; Xu т.б., 2024)
...
(Srivastava т.б., 2014) бірліктердің сынғыш, бірлесіп бапталған детекторларға
...
Негізгі хаттама – Grill т.б. (2020) теріс мысалсыз мақсат функциясы; ол шағын batch-тарға төзімді әрі сол себепті бір құрылғылық есептеу бюджетіне жарамды; ал He т.б.
(2020), Chen т.б. (2020), Chen пен He (2021) және Caron т.б. (2021)
баламалары сақталады; Arrieta т.б. (2022) осы тұқымдасты дәл осы ауруға қолданады. Әрі
...
таңбаларды тек сүзгінің өзі оқиды, оларды алдын ала оқыту мақсат функциясы ешқашан оқымайды. Сондықтан ол претекст міндетіне ешқандай ағып кету енгізбейді.
...
adversarial туралау жолымен бейімдеу (Ganin т.б., 2016) – сол алшақтыққа берілген өзге
жауап әрі мұнда таңдалған жауап емес. Zhou т.б. (2023) жарияланған торқабықтық
іргелі моделі – vision transformer болғандықтан, одан инициализациялау базалық тармаққа қатысты
...
екі ось бойынша – алдын ала өңдеу тармағы мен инициализация көзі бойынша – ерекшеленетіндіктен, тәуелсіз айнымалы екеуінің құрамасы болып табылады, ал тармақтар арасындағы кез келген айырма
...
Бұл таңдаудың әдебиеттегі мәртебесін анық айту қажет. Zhou т.б. (2023) торқабық
кескіндерінде домен ішіндегі өздігінен бақыланатын алдын ала оқыту жалпыланатын репрезентациялар
беретінін, ал Azizi т.б. (2021) домен ішіндегі медициналық алдын ала оқытудың табиғи
...
Екінші кезеңде жоғарғы қабаттар бірте-бірте босатылып, баспен бірге оқытылады. Yosinski т.б. (2014) көрсеткендей, жоғары деңгейлі белгілер міндетке ең тәуелді, демек бейімдеуден
...
да, екі тармаққа да бірдей қолданылады: оқыту рәсімі төрт конфигурация арасындағы айырма
...
Мақсат функциясы – кері жиілікті класс салмақтауы бар Lin т.б. (2017) focal loss-ы;
ол Cui т.б. (2019) тиімді сан бойынша қайта салмақтауына балама, әрі онда екі тетік
...
дәреженің кері жиілігі болып табылады, сөйтіп сирек дәрежелер басылып қалмай, өз сиректігіне
пропорционал үлес қосады.

Сонымен, focal мүшесі оңай мен қиын мысалдар арасындағы теңгерімсіздікті, ал салмақтау класс
...
бола тұра, әлсіз валидацияланған күйде қалатын әдебиеттің аясында жасалады: Araf т.б. (2024) жүйелі шолуы қаралған жүз жетпіс үш мақаланың екеуі ғана валидация зерттеуі
екенін тапты. Buda т.б. (2018) теңгерімсіздікке қарсы шаралар туралы ұқсас оқылымға
...
Messidor-2-ні Decenciere т.б. (2014), ал құрылғылық корпустарды өзгелермен қатар Liu
т.б. (2022) құжаттайды. IDRiD-ті Porwal т.б. (2018) құжаттайды: бір
...
ретинопатия белгілері жоқ дәрежеде шоғырланып, одан кейін күрт төмендейді: ауыр және
...
басталмайды: жіктеуіш оны басым дәрежені жақтау арқылы ғана көтере алады. Тиісінше, негізгі өлшемдер – салмақталған F1-score және квадраттық салмақталған каппа; соңғысы бірнеше ауырлық қадамы бойынша
...
Дәреже бойынша стратификациялау класс үлестерін фолдтар арасында сақтайды, сөйтіп сирек ауыр
дәрежелер біреуінде шоғырланбай, әр тест бөлігінде кездеседі. Хаттама аугментацияның тек оқытуда қолданылуымен үйлеседі: бірде-бір аугментацияланған кескін тест бөлігіне жетпейді.

Клиникалық топты бір мұраланған шектеу шектейді. IDRiD дескрипторы класс үлестірімі туралы статистиканы жарияламағандықтан, ондағы стратификация сыртқы үлестірімдік тіректі пайдаланбай,
...
бекітілген параметрлерімен қолданылды, ал нормалау кезеңі бастапқы доменнің статистикаларын пайдаланды: ешбір нысаналы үлестірімнің қасиеті түрлендіруге кірген жоқ. Екі тармақ та
...
Екі тармақ та табалдырықтан асады: базалық 0.858, интеграцияланған 0.898. Сонымен, өлшем оларды ажыратпайды, ал табалдырықтан өтуді тұжырым ретінде ұсыну дәлелді бұрмалар еді. Ажырататын нәрсе –
...
Қатынас әр тармақтың өз домен ішіндегі ұпайына қатысты есептелетіндіктен, бастапқы ұпайды
...
Екі болжамдық мән де өсті: жақсару жағдайларды талғамсыз көбірек жолдау есебінен алынған
...
Екі корпус та өтеді: гипотеза қолдау табады. Бір ескертпе ескертпе ретінде емес, толық
...
Яғни, салыстыру – бекітілген домен ішіндегі қордан гипотеза тексеруге кіріскен дәл сол шаманы
...
қабаттасуды айту қажет: топтардың екеуі – жаңа ғана баяндалған екі клиникалық корпус болғандықтан, олардың мәндері мен аралықтары құрылысы бойынша сол жолдармен дәл келеді. Олар тәуелсіз қайталау
...
сақтауға тиіс. Бесеуі де екі тармақта да одан асады: өлшем тағы да ажыратпайды.
...
өнімділігіне бөледі, ал интеграцияланған тармақтың бөлгіші үлкенірек. Сол себепті домен ішінде жақсарған тармақ өз қатынасын ұстап тұрудың өзі үшін нысанада пропорционал көбірек жақсаруға тиіс.
Бұл – өнімділік тұжырымы емес, бөлгіш артефактісі, әрі оның бағытына ешқандай қорытынды сүйенбейді.

Үш бағалауды да бірнеше шектеу қоршайды. Әрқайсысы жалғыз кросс-валидация фолдының модельдерін пайдаланды: фолдаралық дисперсия жоқ, ал аралықтар бапталған модельдің құбылмалылығын
...
Бес жабдықтық топтың екеуі тәуелсіз дәлел бермегендіктен, бөлек орталардың тиімді саны бестен
...
Осылайша, карта мен сарапшы аннотациясының беттесуі модель салмақтаған нәрсе мен дәрігер белгілеген
...
Жоба жұптық, ал шағын корпусты пайдалануға келетін ететін де осы жұптау. Екі тармақ та әр кескінге карта беретіндіктен, салыстыру әр кескіннің ішінде жүргізіледі әрі кескіндердің қиындық айырмасы
...
екі тармақта да нөл болды: 48 жұп ақпарат алып жүрді. Екі тармақ бұл backbone аясында
құзіреті жағынан да шамалас болды – салмақталған F1 бойынша 0.7545 және 0.7766. Сондықтан назар айырмасы жұмыс істейтін модель мен сәтсіз модельді салыстыру емес.
...
Сонымен, жиынтық нәтиже қолайлы ішкі жиынның емес, әдеттегі кескіннің қасиеті. Нашарлаған кескіндер
...
бұрыннан оқытылған әрі бағаланған модельді визуализациялайтындықтан, салыстыруды жіктеу
...
фолдты және өз оқыту конфигурациясын пайдаланды: оның жіктеу қоры мен факторлық
...
26-сында жұмсақ экссудаттар бар. Сол себепті кез келген жеке түр үшін шама дәл бағаланбаған.
...
Екіншісі – гипотеза қарастыратын, қазақстандық клиникалық корпустағы назарды сапалық зерттеу. Ол қабаттамалар жасалмағандықтан, гипотеза бір аннотацияланған ашық корпуста тек сандық жартысында
...
Скрининг құралын қабылдауы мүмкін мекемелердің көпшілігінде жағдай басқаша. Өз оқыту жиынын
...
IDRiD көлемі жағынан EyePACS-тен шамамен жетпіс есе кіші: баптау режимі мол корпустан
...
Үшіншіден, бағалау корпусы – жабық клиникалық жиын. Ол ведомстволық келісім бойынша ұсталады әрі жария етілмейді. Сондықтан баяндалғандардың ішінде тек осы экспериментті сыртқы тарап тәуелсіз қайталай
...
Үшеуіне де тек факторлық эксперимент жол береді. Ол пациент деңгейіндегі бес фолд береді: фолд шашырауы мен аралас әсерлер моделі қолжетімді; дана-бойынша қайта іріктеу бағалау іріктемесін
қарастырады; ал әр фолдтың ішіндегі ортақ бөлу бірдей кескіндердегі жұптық тестілерді қолдайды. Әр сыртқы бағалау тармаққа бір бапталған модельді пайдаланды. Сондықтан оның аралықтары бағалау
...
әртүрлі өлшемдермен алдын ала айқындалғандықтан, олар бойынша жалғыз қателік деңгейінің айқын
...
Тиісінше, сыртқы бағалаулардың аралықтары өздері көрсетіп тұрғандай көрінетін жалпы белгісіздіктен
...
|---|---|---|---|---|
| Gulshan т.б. (2016) | Бинарлы, жолдама берілуге тиіс | Жабық оқыту деректері; екі ретроспективті валидация жиыны | Офтальмологтар алқасы | ROC-AUC 0.991 және 0.990 |
| Ting т.б. (2017) | Бинарлы, жолдама берілуге тиіс | Ұлттық бағдарлама, он сыртқы когорт | Бүркемеленген торқабық маманы | ROC-AUC 0.936 |
| Abràmoff т.б. (2018) | Бинарлы, автономды жолдама | Перспективті, 900 пациент, он алаң | Оқу орталығының дәрежелеуі | Сезімталдық 87.2%, спецификалық 90.7% |
| Zhang т.б. (2022) | Бинарлы, жолдама берілуге тиіс, пациент деңгейінде | 83 465 кескін, төрт орталық, жабық | Мамандар консенсусы | ROC-AUC 0.9848 |
| Ruamviboonsuk т.б. (2022) | Бинарлы, көруге қауіп төндіретін | Перспективті орналастыру, тоғыз алаң | Төрелікпен келісілген мамандар | Сезімталдық 91.4%, спецификалық 95.4% |
| De Fauw т.б. (2018) | Оптикалық когеренттік томографиядан жолдама | Жабық | Жолдама консенсусы | Өзге модальдік |
...
| Wewetzer т.б. (2021) | Мета-талдау, бастапқы медициналық көмек | Әртекті, біріктірілген | Зерттеуге тәуелді | Жиынтық ROC-AUC 0.9543 |
...
түсіріп тастайды. Салдары сын емес, практикалық: олардың нәтижелерін осы тарау өзінікін ыдыратқандай ыдыратуға болмайды; ақырғы нүктелер үйлескен күннің өзінде салыстыруды бақыланатын етіп
...
Бұл тұжырым желімен шектелген, әрі бұл шектеу тек формалдық сипатта қалмайды. Конвейер модельге бірде-бір тензор
...
Дәлелдің құрылымының өз шектеулері бар. Факторлықтан тыс әр бағалау тармаққа бір бапталған модельді пайдаланды: ол аралықтар жалпы белгісіздіктен тар. Көптікке түзету жеті гипотезаны емес,
бір экспериментті қамтығандықтан, дәлелдер базасы бойынша тұтастай ешбір қателік деңгейі
бақыланбайды.
...
Қайта жаңғыртылымдық пен салыстыру да шектелген. Жабық клиникалық корпусты қайта таратуға болмайды. Сондықтан оған тәуелді нәтижелер тәуелсіз қайта жаңғыртылмайды. Негізгі эксперименттің екі тармағы
...
Әр деңгейде тұрақты ұсталған бір инициализация аясында сегіз кезеңнің кумулятивті қосылуы сол ұтысты толығымен жаңғыртты: алдын ала өңдеу үлесі инициализация үлесінен ажыратылады. Екі
...
нөлді қамтымады, әрі бұл түрлендірудің бірде-бір нысаналы корпусты көрмеуімен қатар жүрді. Осылайша, алдыңғы бөлімдер тек қорытып шығара алатын механизм өлшенді.
...
туындаған жерде орнатылған. Қабылдау табалдырықтарының екеуінен екі тармақ та өтеді. Сондықтан оларда дәлел өлшемде емес, салыстыруда және шашыраудың азаюында жатыр. Назар нәтижесі бір
...
Бір әдіснамалық байқау үш бағалауда қайталанды әрі ол оларға кездейсоқ түрде түспеген. Үш өлшемнің әрқайсысы
...
Архитектура мұнда алғаш рет ұсынылып отырған жоқ. Кандидаттың бұрынғы жұмысы (Yesmukhamedov т.б., 2025) офтальмологиялық скринингке арналған модульдік жүйені ұсынып, оны кескінді
...
тексеруді ұсынады. Әр соңғы нүкте бір модульге сәйкес келеді: оқырман архитектурада
...
Іске асырудың үш қасиеті жүйе арналған ортадан туындайды. Клиент – статикалық жинақ болғандықтан, оны кез келген хостан беруге және кэштеуге болады, әрі ол модельді де, пациент деректерін де ұстамайды.
Сервис сұраныстар арасында күйсіз, тек істер қоймасынан басқа, ал ол дерекқор емес, дискідегі каталог. Сондықтан жүйе файл жүйесінен артық ешбір серверлік тәуелділік алып жүрмейді.
...
бұл эксперименттер пайдаланған дәл сол код жолы, көрсету үшін жасалған қайта іске асыру емес. Сондықтан оператор жіберілген кескінге қолданылғанын көретін нәрсе – корпустарға қолданылған нәрсенің
өзі.
...
бас тарту элементіне ауысады, ал бас тарту оны жояды: жазба бір болжамның бірнеше
...
дискімен қамтамасыз етілген пішін одан аман шығады. Жазбалар мүмкіндігінше жазылады, сол себепті біреуін сақтай алмау болжамды сәтсіз етпейді.
...
Бастапқы жоба (Yesmukhamedov т.б., 2025) сипаттайтын екі мүмкіндік айқындама күйінде
...
әрі мұнда іске аспаған. Екеуі де кеңірек жазбада орныққан жеткізу тәсілдері (Bellemo т.б., 2019; Ting т.б., 2019; Morya т.б., 2024).
...
Бастапқы жобаның (Yesmukhamedov т.б., 2025) деректерді қорғау шеңберлеуі – сертификатталған
...
мұнда көрсетілген ешнәрсемен өзгермейді. Beede т.б. (2020) мұндай алғышарттары жоқ
...
Бар нәрсе – модуль шекаралары интерфейс шекараларымен беттесетін инференс сервисі мен браузер клиенті: ыдыратуды тек диаграммамен емес, жұмыс істеп тұрған жүйемен салыстырып тексеруге
...
ертеректегі артефакт, ал оның қасында көрсетілетін көрсеткіштер орны басылған прогоннан келеді. Сондықтан демонстратор көрсететін ештеңе осы диссертациядағы ешбір санның көзі емес. Оның таныстыру
...
Сонымен, тараудың мәлімдейтіні тар. Жоба іске асады, ол сипатталған бөлігінде іске асырылған, әрі
...
өлшемдер 2.6-бөлімдегі өлшемдер кестесінде қосалқы деп белгіленген: олар негізгі өлшемдерді оқуға
көмектеседі
...
эпохалардың шашырауы бір мен бір жарым эпоха аралығында: жинақталу режимі нақты бір
фолдтың емес, конфигурацияның қасиеті.

### Ә.6 Аралық бағалары

Екі аралық келтіріледі әрі олар әртүрлі нәрсені сандық өлшейді. Кросс-валидация аралығы бес фолд бойынша алынады және қайта баптаудың құбылмалылығын қамтиды. Дана-бойынша bootstrap аралығы
бағалау жиынын бекітілген бапталған модель аясында қайта іріктейді әрі тек бағалау корпусының іріктелуін сандық өлшейді.
...
**Класс-бойынша ROC және дәлдік–толықтық қисықтары.** Олар дана-бойынша болжанған ықтималдықтарды талап етеді. Дана-бойынша болжам дампы сақталмағандықтан, қисықтарды қолда бар жазбадан алу мүмкін емес. Демек, осы диссертациядағы табалдырықтан тәуелсіз дәлел жоғарыда және 3-тарауда келтірілген жиынтық және жолдама ROC-AUC көрсеткіштерімен шектелген.
...
Бұл қосымшаның екі жартысы бар. Біріншісі 4-тарауда сипатталған скрининг жүйесі архитектурасының
формальды құрылымдық көріністерін береді: компоненттік көрініс, орналастыру көрінісі, бір скрининг
эпизодының реттілік көрінісі және сақталатын деректер моделі. Олар бірге сонда белгіленген жүйе
архитектурасының диаграммасын береді. Екіншісі жұмыс істеп тұрған демонстраторды жұмыс үстінде
көрсетеді, сонда Б.1-кесте құрылған деп белгілеген модульдердің кестеде айтылғанды істеп тұрғанын
көруге болады.
...
тіреледі; сол тарау қандай да бір егжей-тегжейді бекітпеген жерде ол мұнда таңдалмай, түсіріледі: диаграммаларда диссертация прозада қабылдамаған ешбір жобалық шешім жоқ.
...
ұстамайтын статикалық жинақ, ал сервисі жеделдеткіш бар жерде жүреді: оператор отыратын
...
### Б.5 Демонстратор жұмыс үстінде

Төменде берілген үш сурет жобаны емес, демонстратордың өзін көрсетеді. Олар мұнда, себебі Б.1-кесте
жеті модульді құрылған деп белгілейді, ал мұны бекітетін кестенің құны жүйенің оны істеп тұрғанынан
төмен. Әрқайсысы 4.3-бөлімде сипатталған клиенттің суреті, ол 4.2-бөлімдегі инференс қызметін
жүргізеді.

**[FIG-C.1: Жіберу көрінісі: бір пациенттің екі көзі дәрежелеуге қабылданған, астында алдын ала өңдеу
кезеңдері ашылған – defense/figures/1.png]**

C.1-сурет Б.1-кестедегі «Қабылдау» және «Алдын ала өңдеу қозғалтқышы» жолдарын жұмыс үстінде
көрсетеді. Екі кескін бір пациент ретінде жіберіледі – оң көз және сол көз, – ал астындағы панель
таңдалған көз үшін конвейердің кезеңдерін бір-бірлеп өтіп, әр кезең беретін арналарды атайды. Осылайша, түрлендіру жасырын емес, қаралатын болады, ал бұл – осы диссертацияның архитектуралық ұстанымының
интерфейске көшкен түрі: алдын ала өңдеу модельдің бөлігі әрі сол күйінде көрсетіледі, деректерді
дайындау ретінде жасырылмайды.

**[FIG-C.2: Нәтиже көрінісі: пациент деңгейіндегі дәреже, бес дәреже бойынша үлестірім, әр көз бойынша
болжамдар және қарау басқармалары – defense/figures/2.png]**

C.2-сурет «Инференс» және «Шешім қолдау» жолдарын көрсетеді. Жүйе пациент деңгейінде бес класты
дәреже қайтарады, оның астында бес дәреженің бәрі бойынша үлестірім, жолдамаға жататын-жатпайтыны
және әр көз бойынша болжам тұрады. Визуализация панелі өз шегін өзі айтады – түсіндірілімділік
дәлелі, клиникалық зақымдану локализациясы емес, – ал бұл суретте қолжетімді қабаттама жоқ деп
хабарлайды, себебі назар картасы чекпоинттен қызмет оны шығара алған жағдайда ғана жасалады. Одан
кейінгі басқармалар болжам бойынша шешімді дәрігерге қалдырады, ал бұл – Б.3-диаграммадағы
«дәрігер-циклде» реттілігінің іске асқан түрі.

**[FIG-C.3: Шешім тіркелгеннен кейінгі көрініс: сақталған жағдай, қайта таңбалау буфері және жағдайлар
қоймасынан оқылған жиынтық – defense/figures/3.png]**

C.3-сурет «Дәрігер интерфейсі» және «Деректерді басқару» жолдарын көрсетеді. Шешім сервердегі
жағдай жазбасына сақталады әрі қайта оқыту үшін экспорттауға болатын қайта таңбалау буферіне
қосылады, ал астындағы жиынтық браузер сеансынан емес, жағдайлар қоймасынан оқылады. Бұл –
Б.4-диаграммадағы аудит арнасының құрылған түрі: жергілікті жағдайлар қоймасы, ал ауруханалық кескін
және жазба жүйелерімен байланыстар әлі айқындама күйінде.

### Осы көріністердің мәртебесі

Төрт диаграмманың әрқайсысы 4.1-бөлімдегі ыдыратуды тарқатады, әрі әрқайсысы Б.1-кесте арқылы соған
барып тіреледі. Олардың бірде-бірі мінез-құлық туралы дәлел емес. Үш сурет құрылған деп белгіленген
модульдердің бар екенін әрі жұмыс кезінде не істейтінін көрсетеді, бұдан артық ештеңе көрсетпейді:
олар өлшем емес, олардан кідіріс, өткізу қабілеті немесе сенімділік көрсеткішін оқуға болмайды, ал
олардағы жағдайлар саны пайдаланудан емес, әзірлеу сеансынан. Ешбір клиникалық жағдайда далалық
сынақ жүргізілген жоқ, әрі бұл қосымшадағы ештеңе қызметтегі сенімділік, клиникалық пайдалылық
немесе нормативтік мәртебе туралы тұжырым алып жүрмейді.
...
**Топтамалардың үшеуі бірден көп камера моделін біріктіреді.** Олар жеке аспапты емес, құрылғылар тұқымдасын және түсіру контексін сәйкестендіреді: топ-бойынша көрсеткіш құрылғы-бойынша көрсеткіш емес.

**Бағалау жалғыз кросс-валидация фолдының модельдерін пайдаланады.** Яғни, Г.7-бөлімде келтірілген шашырау – фолдтар арасындағы емес, *топтар арасындағы* шашырау, әрі осы қосымшадағы бірде-бір көрсеткіш үшін фолдаралық дисперсия қолжетімді емес.
