...
> **STAGE-G (түпкі өту) — 2026-09-06.** Жұмыстық автор-жыл дәйексөздері нөмірленген `[N]` түріне түрлендірілді (GOST 7.32-2001 §6.11, алғаш кездесу ретімен). 102 сыртқы дереккөз [1]–[102] болып нөмірленді. Нөмірлер ағылшын тіліндегі мәтінмен ортақ (тіл-инварианттылық).
...
[1], және Procedia Computer Science, 272-том, 496–501
конференция баяндамасы [2].
...
Physico-Mathematical Series, 2(354), 74–91 [3]; Herald of the Kazakh-British Technical University, 22(4), 119–130 [4]; және Herald of KazUTB, 2(27-740), 20–30 [5].

2-тарау [1, 2, 4] жұмыстарына, 4-тарау [3]
жұмысына, ал 1.1-бөлімдегі лазер моделі [5] жұмысына сүйенеді.
...
капиллярлық қабатында зақымдануды тудырады, ал Kusuhara т.б. [6] перициттердің
...
жаңғыртатынын ескертеді. Түсіндірме толық та емес. Wang пен Lo [8] және Gettinger т.б. [9] ауруды микротамырлық зақымдану, қабыну және нейродегенерацияның қосындысы деп
...
Клиникалық шкала бұл жүкті ауырлық кластарына бөледі. Morya т.б. [7] жинақтағандай,
...
Ерте анықтау клиникалық тұрғыдан шешуші, өйткені Kesharwani т.б. [10] мен Wang пен Lo [8] хабарлағандай, ауру ерте дәрежелерінде емделеді, ал терапиялық терезе ол әлі бұлыңғыр
...
Қажетті скринингтің жүзеге аспай отырғанын байқалған қамту көрсеткіші көрсетеді: Morya т.б. [7] жыл сайынғы ұсынылған тексеруден өтетіндер үлесін пациенттердің үштен бірі мен
...
Morya т.б. [7] жеткізетін енгізілген автоматтандырылған жүйелер және Yesmukhamedov
т.б. [3] баяндайтын ұлттық скрининг бағдарламасы бұл нақты мүмкіндік екенін
...
Кандидаттың бұрынғы жұмысында [5] баяндалған осы байланысқан модельді
...
жіктеледі – Shen т.б. [11] арнайы көз түбін жақсарту желісін оқыту үшін дәл осы
...
тек сапаны өзгерте отырып, Fu т.б. [12] отыз мыңға жуық кескінді үш сапа деңгейіне
қайта аннотациялап, сапа төмендеген сайын анықтау дәлдігінің монотонды түрде құлдырайтынын тапты.
Zago т.б. [13] дәл сол байланыстың дерекқорлар арасында да сақталатынын хабарлайды,
ал Dai т.б. [14] өнеркәсіптік жүйесі дәрежелеудің алдына айқын сапа кезеңін қояды.
...
дереккөздер арасында дәлме-дәл бірдей ұстаудан келеді. Voets т.б. [16] Gulshan т.б. [17] конвейерін ашық деректерде қайта жаңғыртты. Олар бір тест корпусында қисық
...
Voets т.б. [16] шамадан тыс күшті оқылымға жол бермейтін екі нюанстың бірінші
...
Beede т.б. [18] сүзгінің құнын орналастыру жағынан күшейтеді: он бір клиникада
...
Екінші нюанс міндетке тәуелділікке қатысты. Liu т.б. [19] баяндаған бенчмаркта
...
Әдебиет мұны домендік ығысу ретінде зерттейді. Zhou т.б. [20] саланы шолып,
...
сол backbone-дарда құрылды. Litjens т.б. [26] осы қозғалысты медициналық бейнелеу
бойынша кеңірек шолады.

Ол архитектуралар сүйенетін тереңдікті оқытуға келетін етіп екі байланыс жаңалығы жасады. He т.б. [27] әр блокты бірегейлік қысқа жолдары арқылы өз кірісіне қатысты қалдық функцияны
үйренетіндей қайта тұжырымдайды, ал Huang т.б. [28] алдыңғы қабаттардың барлығының
...
жуық болатындай тиімді [44, 45], ал Cheplygina т.б. [46] оның негізін береді: ерте конволюциялық белгілер негізінен жалпы сипатта әрі
...
Zhou т.б. [47] торқабық кескіндерінде өздігінен бақыланатын алдын ала оқыту
жалпыланатын торқабықтық репрезентациялар беретінін, ал Azizi т.б. [48] домен ішіндегі
...
арасында жатыр, ал Saxena т.б. [49] деректер мүмкіндік берген жерде екіншісінің
...
Басым тұқымдас класс дәлелін соңғы конволюциялық активацияларға кері проекциялайды [50]. Selvaraju т.б. [51] ұсынған градиентке негізделген түрі кез
келген конволюциялық архитектураға қайта оқытусыз қолданылатындықтан, ол әдепкі тәсілге
айналды, ал Chattopadhyay т.б. [52] нақтылауы градиенттердің қалай салмақталатынын
өзгертеді. Модельден тәуелсіз баламалар да бар [53, 54].

Саланың бұл карталарды қолдануы маңызды бір қырынан біркелкі болмады, оны Samek т.б. [55] мен Tjoa мен Guan [56] шолулары атап өтеді. Назар картасы мен сарапшы аннотациясының
...
мұндағы дәлелге тікелей қатысты. Wan т.б. [57] ұсақ зақымдану белгілерін сақтау үшін
...
Саланың жоғары өнімді жүйелер шығарғаны дауға түспейді. Gulshan т.б. [17] терең
...
Abramoff т.б. [58] жүйесі перспективті көпорталықты сынақта нормативтік рұқсатқа
қол жеткізді.

Әдебиет сондай-ақ бір орталықтағы ішкі валидациядан әлдеқайда әрі жетілді: Ting т.б. [59] көпэтносты сыртқы когорттары, Сахарадан оңтүстіктегі Африкадағы популяцияаралық валидация
...
[62]. Ting т.б. [63] мен Senapati т.б. [64] саланы тұтастай шолады, ал Wewetzer т.б. [65] бастапқы медициналық көмек
...
|---|---|---|---|---|---|
| Gulshan т.б. [17] | Бинарлы, жолдама берілуге тиіс | Жабық әзірлеу деректері; екі ретроспективті валидация жиыны | ROC-AUC 0.991 және 0.990 | Қос сыртқы | Алдын ала өңдеу қосымша материалға шығарылған |
| Abràmoff т.б. [58] | Бинарлы, автономды | 900 пациент, бастапқы медициналық көмектің он алаңы | Сезімталдық 87.2%, спецификалық 90.7% | Перспективті түйінді сынақ | Алдын ала өңдеу абляциясы жоқ, ашық бенчмарк жоқ |
| Ting т.б. [59] | Жолдама берілуге тиіс | Жабық, оған қоса он көпэтносты жиын | ROC-AUC 0.936; сыртқы 0.889–0.983 | Көпэтносты сыртқы | Әзірлеу деректері жабық |
| Bellemo т.б. [60] | Жолдама берілуге тиіс | 4 504 кескін, Замбия | ROC-AUC 0.973 | Популяцияаралық | Бір елдегі когорт |
| Zhang т.б. [61] | Жолдама берілуге тиіс | 83 465 кескін, төрт орталық | Пациент бойынша AUROC 0.9848 | Көпорталықты | Бір ел; алдын ала өңдеу хабарланбаған |
| Ruamviboonsuk т.б. [62] | Көруге қауіп төндіретін | 7 651 пациент, тоғыз алаң | Дәлдік 94.7%, сезімталдық 91.4% | Перспективті, ұлттық бағдарлама | Архитектура мен алдын ала өңдеу мөлдір емес |
| Sánchez-Gutiérrez т.б. [66] | Жолдама берілуге тиіс | Жабық, Испания | ROC-AUC 0.988 | Клиникалық валидация | Деректер жабық |
| Baget-Bernaldiz т.б. [67] | Төрт класты | Жабық, оған қоса бір ашық жиын | ROC-AUC 0.988 және 0.968 | Сыртқы | Бір популяцияда әзірленген |
| Saxena т.б. [49] | Бинарлы | Ашық әзірлеу деректері, екі ашық тест жиыны | ROC-AUC 0.958 және 0.92 | Корпусаралық | Бинарлы міндет; алдын ала өңдеу сырттан алынған |
| Wewetzer т.б. [65] | Жолдама берілуге тиіс, біріктірілген | Бастапқы медициналық көмектегі он зерттеу | Жиынтық ROC-AUC 0.9543 | Мета-талдау | Әртекті зерттеулерді біріктіреді |
...
әрі мөлдір емес, ал жоғары өнімді кейбір модельдер, мысалы Ryu т.б. [68] моделі,
...
немесе формальданған. Senapati т.б. [64] шолуы дәл сол жазбаны қарайды әрі
...
Конвейер кандидаттың бұрын жарияланған жұмыстарында [1, 2, 4] басталған желіні – онда дәстүрлі алдын ала өңдеу шағын конволюциялық желіде
...
белгілейді. Pizer т.б. [74] сондай-ақ қолайлы кесу деңгейлерінің бейнелеу
...
себебін күшейтеді. Hayati т.б. [72] контрасты шектелген теңестіруді төрт архитектурада
...
нашарлайды, әрі бұл – артық үйрену емес, оңтайландыру сәтсіздігі. He т.б. [27] мұны
...
Мұны Wan т.б. [57] зақымдануды сегменттейтін желісі көрсетеді: ол ұсақ зақымдану
...
Бүкіл жұмыс бойында әртүрлі тұқымдастан алынған екі backbone қолданылады. Біріншісі – He т.б. [27] қалдық архитектурасының елу қабатты данасы, оның айқындаушы элементі –
...
Негізгі хаттама – Grill т.б. [79] теріс мысалсыз мақсат функциясы; ол шағын batch-тарға төзімді әрі сол себепті бір құрылғылық есептеу бюджетіне жарамды; ал He т.б. [80], Chen т.б. [81], Chen пен He [82] және Caron т.б. [83]
баламалары сақталады; Arrieta т.б. [84] осы тұқымдасты дәл осы ауруға қолданады. Әрі
...
жауап әрі мұнда таңдалған жауап емес. Zhou т.б. [47] жарияланған торқабықтық
...
Бұл таңдаудың әдебиеттегі мәртебесін анық айту қажет. Zhou т.б. [47] торқабық
кескіндерінде домен ішіндегі өздігінен бақыланатын алдын ала оқыту жалпыланатын репрезентациялар
беретінін, ал Azizi т.б. [48] домен ішіндегі медициналық алдын ала оқытудың табиғи
...
Екінші кезеңде жоғарғы қабаттар бірте-бірте босатылып, баспен бірге оқытылады. Yosinski т.б. [87] көрсеткендей, жоғары деңгейлі белгілер міндетке ең тәуелді, демек бейімдеуден
...
Мақсат функциясы – кері жиілікті класс салмақтауы бар Lin т.б. [88] focal loss-ы;
ол Cui т.б. [89] тиімді сан бойынша қайта салмақтауына балама, әрі онда екі тетік
...
бола тұра, әлсіз валидацияланған күйде қалатын әдебиеттің аясында жасалады: Araf т.б. [90] жүйелі шолуы қаралған жүз жетпіс үш мақаланың екеуі ғана валидация зерттеуі
екенін тапты. Buda т.б. [91] теңгерімсіздікке қарсы шаралар туралы ұқсас оқылымға
...
Тізбек Zhou т.б. [50] класс активациясын карталауынан басталады. Соңғы белгі
...
Selvaraju т.б. [51] градиентке негізделген жалпылауы сол салмақтарды градиенттермен
...
келген конволюциялық архитектураға қайта оқытусыз қолданылады. Chattopadhyay т.б. [52] кейінгі нақтылауы пиксельдік салмақтарды жоғары ретті мүшелерден шығарады; мұндағы нұсқалар
...
өлшейді. Екіншісі – Everingham т.б. [92] симметриялы «қиылысу бөлінген бірігу»
өлшемі; оның бөлімі назардың зақымданудан тыс шығып кеткені үшін де, назар жаба алмаған зақымдану
үшін де айып салады; Rezatofighi т.б. [93] оның мінез-құлқын талдайды.
...
Құрылымдық ұқсастық Wang т.б. [94] жалпы кескін сапасы бенчмаркінен шығады, оның
...
Messidor-2-ні Decenciere т.б. [99], ал құрылғылық корпустарды өзгелермен қатар Liu
т.б. [19] құжаттайды. IDRiD-ті Porwal т.б. [100] құжаттайды: бір
...
құрама масштабталған желіні – білдіреді; соңғысы кандидаттың бұрынғы жұмысынан [2, 4] келеді, әрі бірде-бірі осы міндет үшін оңтайлы деп бекітілмейді.
...
|---|---|---|---|---|
| Gulshan т.б. [17] | Бинарлы, жолдама берілуге тиіс | Жабық оқыту деректері; екі ретроспективті валидация жиыны | Офтальмологтар алқасы | ROC-AUC 0.991 және 0.990 |
| Ting т.б. [59] | Бинарлы, жолдама берілуге тиіс | Ұлттық бағдарлама, он сыртқы когорт | Бүркемеленген торқабық маманы | ROC-AUC 0.936 |
| Abràmoff т.б. [58] | Бинарлы, автономды жолдама | Перспективті, 900 пациент, он алаң | Оқу орталығының дәрежелеуі | Сезімталдық 87.2%, спецификалық 90.7% |
| Zhang т.б. [61] | Бинарлы, жолдама берілуге тиіс, пациент деңгейінде | 83 465 кескін, төрт орталық, жабық | Мамандар консенсусы | ROC-AUC 0.9848 |
| Ruamviboonsuk т.б. [62] | Бинарлы, көруге қауіп төндіретін | Перспективті орналастыру, тоғыз алаң | Төрелікпен келісілген мамандар | Сезімталдық 91.4%, спецификалық 95.4% |
| De Fauw т.б. [101] | Оптикалық когеренттік томографиядан жолдама | Жабық | Жолдама консенсусы | Өзге модальдік |
...
| Wewetzer т.б. [65] | Мета-талдау, бастапқы медициналық көмек | Әртекті, біріктірілген | Зерттеуге тәуелді | Жиынтық ROC-AUC 0.9543 |
...
мұнда көрсетілген ешнәрсемен өзгермейді. Beede т.б. [18] мұндай алғышарттары жоқ
