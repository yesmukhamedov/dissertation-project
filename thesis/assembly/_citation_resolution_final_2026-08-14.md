# Stage-G citation conversion — FINAL resolution & QA (2026-08-14)

Sources: `DISSERTATION_EN_partial_2026-08-14.md` + `DISSERTATION_KZ_partial_2026-08-14.md`.  Outputs: `DISSERTATION_EN_GOST_2026-08-14.md`, `DISSERTATION_KZ_GOST_2026-08-14.md`.
Numbering assigned ONCE by first appearance in EN, reused verbatim in KZ (rule #7).

## Summary
- External sources numbered: **107**  |  Highest [N]: **107**
- Bracketed citations placed — EN: **292** | KZ: **267**
- Residual *resolvable* author-year (BLOCKING) — EN: **0** | KZ: **0**
- Left as author-year by policy — self EN/KZ: **0/0** ; App-D EN/KZ: **4/4**
- UNKNOWN author-year (needs a card or is non-citation prose) — EN: **1** | KZ: **0**
...
### EN
- paren: `(No. 230-VIII of 17 November 2025)`
### KZ
- none
...
96. Sapakova, S. Z., Daniyarova, D. R., Yesmukhamedov, N. S., Armankyzy, R., Emberdieva, A. B., & Kaldybaeva, A. S. (2024). Mathematical modeling of laser exposure on fundus tissues in the treatment of diabetic retinopathy. Herald of KazUTB, 2(27-740). https://doi.org/10.58805/kazutb.v.2.27-740
