...
> **STAGE-G (түпкі өту) — 2026-08-25.** Жұмыстық автор-жыл дәйексөздері нөмірленген `[N]` түріне түрлендірілді (GOST 7.32-2001 §6.11, алғаш кездесу ретімен). 102 сыртқы дереккөз [1]–[102] болып нөмірленді. Нөмірлер ағылшын тіліндегі мәтінмен ортақ (тіл-инварианттылық).
