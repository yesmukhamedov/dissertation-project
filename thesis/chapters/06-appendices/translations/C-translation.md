...
**2026-08-22: Б.5-бөлім қосылды** – демонстратордың үш суреті (`defense/figures/1–3.png`).
Диаграммалар мен суреттер бөлек нөмірленеді: mermaid көріністері «Б.1-диаграмма … Б.4-диаграмма»,
ал жаңа суреттер «C.1-сурет … C.3-сурет» болып басылады. ⚠ Маркердегі әріп латын **C** күйінде
қалады, себебі түрлендіргіштің маркер өрнегі кирилл әрпін қабылдамайды.
