...
results "confirm the effectiveness of laser therapy"; that is the source's claim, and since it is
not needed here it is simply not carried. Nothing is attributed to the model that it does not
support.
