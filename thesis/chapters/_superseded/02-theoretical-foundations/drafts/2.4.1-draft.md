...
**SIR-4 (self-citation transparency)** — ✅ Satisfied. *"presented here as previously published own work (the modeling study reported in the Herald of KazUTB, 2025), re-expressed in independent notation"* (¶1). Equations re-expressed, not reproduced verbatim.
