...
**No promotion above §5.2.2** — ✅ Verified against §5.2.2 and TAB-5.2 claim by claim, all eight empirical claims including PC-11. Every empirical provision is submitted at STRONG with its recorded qualification; PC-0, PC-4 and PC-5 are submitted as non-empirical; nothing is upgraded and no qualification is softened.
...
**PC-11 submitted as a provision** — ✅ Provision 5. The register position is now uniform across the sources: `ARGUMENT_MAP.md` v7.1.0, TAB-5.2 and §5.2.2 all carry the domain-distance result as **PC-11**, a first-class empirical claim at STRONG (direction only), bringing the tally of empirical primary claims to eight. The earlier divergence — TAB-5.2 filing it outside the formal claim register — is closed, and no substance or strength changed in closing it.
