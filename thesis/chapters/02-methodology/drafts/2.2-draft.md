...
superseded sections are rendered as prose: the corpus carries equations, but stating a minimum of
two named quantities in words costs less than three numbered displays and reads the same.
