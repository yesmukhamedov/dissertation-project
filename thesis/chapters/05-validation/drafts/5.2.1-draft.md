...
**Table 5.3 (TAB-5.1). Experiment 1: statistical suite. Bootstrap intervals are per-instance over 1 000 resamples; the paired tests use the identical validation split within each fold.**
