...
[FIG-4.17: Domain-distance reduction per target domain, both measures — ASSET TO BE CREATED]
...
**FIG-4.17 placeholder** — ✅ Satisfied. Rendered as `[FIG-4.17: … — ASSET TO BE CREATED]` per PLAN §3.2; the numeric table is complete, so no data are fabricated by the placeholder.
